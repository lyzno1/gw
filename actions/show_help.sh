...
show_help() {
    ...
    echo "  rm <branch|all> [-f] [--delete-remotes] - 删除本地及可选的远程分支。"
    echo "                            gw rm <branch_name> [-f] [--delete-remotes]"
    echo "                              删除指定的本地分支。"
    echo "                              -f: 强制删除本地分支。"
    echo "                              --delete-remotes: 尝试删除对应的远程分支 (${REMOTE_NAME}/<branch_name>) (会确认)。"
    ...
    echo "                                   - [F] 强制删除所有剩余分支 (危险! 需强确认)。"
    echo "                                   - [S] 跳过所有剩余分支。"
    echo "                              -f 和 --delete-remotes 选项会影响所有删除操作。"
    echo ""
