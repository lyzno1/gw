    ...
    >
      <div className="space-y-10">
        <div>
          ...
          <CodeBlock code="gw start <branch> [--base <base>] [--local]" language="bash" showLineNumbers={false} />
          <h3 className="mt-6 scroll-m-20 text-lg font-semibold tracking-tight">
        ...
        <div>
          ...
          <CodeBlock code="gw save [-m <message>] [-e] [files...]" language="bash" showLineNumbers={false} />
          <h3 className="mt-6 scroll-m-20 text-lg font-semibold tracking-tight">
            {locale === "zh" ? "选项" : "Options"}
          </h3>
          <ul className="my-6 ml-6 list-disc [&>li]:mt-2">
        ...
        <div>
          ...
          <CodeBlock code="gw update" language="bash" showLineNumbers={false} />
          <h3 className="mt-6 scroll-m-20 text-lg font-semibold tracking-tight">
        ...
        <div>
          ...
          <CodeBlock code="gw rm <branch|all> [-f] [--delete-remotes]" language="bash" showLineNumbers={false} />
          <h3 className="mt-6 scroll-m-20 text-lg font-semibold tracking-tight">
            {locale === "zh" ? "选项" : "Options"}
          </h3>
          <ul className="my-6 ml-6 list-disc [&>li]:mt-2">
        ...
        <div>
          ...
          <CodeBlock code="gw clean <branch>" language="bash" showLineNumbers={false} />
          <h3 className="mt-6 scroll-m-20 text-lg font-semibold tracking-tight">
            {locale === "zh" ? "示例" : "Example"}
          </h3>
