    ...
    <DocContent title={t("sidebar.troubleshooting")} description="Solutions for common issues when using GW">
      <div className="space-y-10">
        ...
        <div>
          ...
          <pre className="my-4 overflow-x-auto rounded-lg bg-slate-900 p-4">
            <code className="text-white">
              # Keep changes in working directory gw undo # Keep changes staged gw undo --soft # Discard changes
              completely gw undo --hard
            </code>
          </pre>
          ...
          <pre className="my-4 overflow-x-auto rounded-lg bg-slate-900 p-4">
            <code className="text-white">
              # Find the commit hash before the rebase git reflog # Reset to that commit git reset --hard
              &lt;commit-hash&gt;
            </code>
          </pre>
        </div>
        ...
        <div>
          ...
          <pre className="my-4 overflow-x-auto rounded-lg bg-slate-900 p-4">
            <code className="text-white">
              # In your .bashrc or .zshrc export MAIN_BRANCH="develop" export MAX_ATTEMPTS=5 # Or for a single command
        ...
        <div>
          ...
          <pre className="my-4 overflow-x-auto rounded-lg bg-slate-900 p-4">
            <code className="text-white">
              ls -la /path/to/gw/git_workflow.sh ls -la /path/to/gw/actions/ ls -la /path/to/gw/core_utils/
            </code>
          </pre>
        </div>
      </div>
