      ...
      <ul className="my-6 ml-6 list-disc [&>li]:mt-2">
        <li>
          ...
          <pre className="my-2 overflow-x-auto rounded-lg bg-slate-900 p-2">
            <code className="text-white">
              # Install GitHub CLI - see https://cli.github.com/ for more options # macOS brew install gh #
        ...
        <li>
          ...
          <pre className="my-2 overflow-x-auto rounded-lg bg-slate-900 p-2">
            <code className="text-white">
              # macOS brew install gnu-getopt # Add to PATH in your shell config file export
