...
interface GitOperationsPageContentProps {
  // lang: string;
...
export function GitOperationsPageContent({
  statusExamples,
  addExamples,
  commitExamples,
  pushExamples,
  pullExamples,
}: GitOperationsPageContentProps) {
    ...
    >
      <div className="space-y-10">
        <div>
          ...
          <CodeBlock code="gw status [-r] [-l]" language="bash" />
          <h3 className="mt-6 scroll-m-20 text-lg font-semibold tracking-tight">
        ...
        <div>
          ...
          <CodeBlock code="gw add [files...]" language="bash" />
          <h3 className="mt-6 scroll-m-20 text-lg font-semibold tracking-tight">
        ...
        <div>
          ...
          <CodeBlock code='gw commit [-m "message"] [-e] [...]' language="bash" />
          <h3 className="mt-6 scroll-m-20 text-lg font-semibold tracking-tight">
            {locale === "zh" ? "选项" : "Options"}
          </h3>
          <ul className="my-6 ml-6 list-disc [&>li]:mt-2">
        ...
        <div>
          ...
          <CodeBlock code="gw push [remote] [branch] [...]" language="bash" />
          <h3 className="mt-6 scroll-m-20 text-lg font-semibold tracking-tight">
        ...
        <div>
          ...
          <CodeBlock code="gw pull [remote] [branch] [...]" language="bash" />
          <h3 className="mt-6 scroll-m-20 text-lg font-semibold tracking-tight">
            {locale === "zh" ? "特性" : "Features"}
          </h3>
          <ul className="my-6 ml-6 list-disc [&>li]:mt-2">
